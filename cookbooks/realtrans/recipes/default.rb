...
if node.attribute?('rtcenproxy')
  ...
  rtcenhost = search(:node, "recipes:realtrans\\:\\:realtrans-central OR recipes:realtrans\\:\\:realtrans-server OR role:realtrans AND chef_environment:#{node.chef_environment}")
