...
script "chcon-shibboleth2.xml" do
  interpreter "bash"
  code "chcon -h system_u:object_r:httpd_config_t /etc/shibboleth/shibboleth2.xml"
  code "chcon -R -h root:object_r:httpd_config_t /etc/shibboleth/shibboleth2.xml"
end
...
script "chcon-shib.conf" do
  interpreter "bash"
  code "chcon -h system_u:object_r:httpd_config_t /etc/httpd/conf.d/shib.conf"
  code "chcon -R -h root:object_r:httpd_config_t /etc/httpd/conf.d/shib.conf"
