#
# Cookbook Name:: rf-rm-apache-shib-sp
# Recipe:: default
#
...
#the copy idp-metadata.xml runs at compile time, so the directory has to be created first
...
yum_package "rules-mgmt-ui-httpd" do
   action :install
