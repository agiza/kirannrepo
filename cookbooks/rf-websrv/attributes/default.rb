...
default['shibboleth-sp']['REMOTE_USER'] = "uid"
...
default['shibboleth-sp']['SSO']['entityID'] = "https://test-idp.altidev.net/idp/shibboleth"
...
# Metadata Provider
default['shibboleth-sp']['MetadataProvider']['path'] = "/etc/shibboleth"
