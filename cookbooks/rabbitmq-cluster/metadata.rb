...
maintainer        'Opscode, Inc., Altisource'
maintainer_email  'cookbooks@opscode.com, cosmin.vasii@endava.com'
license           'Apache 2.0'
description       'Installs and configures RabbitMQ server'
version           '3.3.2'
recipe            'rabbitmq-cluster', 'Install and configure RabbitMQ'
recipe            'rabbitmq-cluster::cluster_management', 'Set up RabbitMQ clustering.'
recipe            'rabbitmq-cluster::plugin_management', 'Manage plugins with node attributes'
recipe            'rabbitmq-cluster::virtualhost_management', 'Manage virtualhost with node attributes'
recipe            'rabbitmq-cluster::user_management', 'Manage users with node attributes'
depends           'erlang', '>= 0.9'
